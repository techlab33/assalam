            ...
            child: Form(
              ...
              child: Obx( () =>  Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: screenSize.height / 52.5),
                        ...
                        Center(
                          child: RichText(
                            text: TextSpan(
                              ...
                              style: TextStyle(fontFamily: 'Roboto',fontSize: 14, fontWeight: FontWeight.w400, color: Colors.black87),
                              children: [
                                TextSpan(
                                  text: '  Log In',
                                  style: TextStyle(fontFamily: 'Roboto',fontSize: 15, fontWeight: FontWeight.w600, color: Colors.green),
                                ),
                              ],
                            ),
                          ),
